                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            {!! Form::open(['route' => ['user.update',$user->id],'method' => 'put','class'=>'form-horizontal form-label-left','data-parsley-validate novalidate']) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    {!! Form::select('role', $roles, $user->roles()->first()->id, ['class' => 'form-control col-md-7 col-xs-12','placeholder' => 'Seçiniz','required']) !!}
