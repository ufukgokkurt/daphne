                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            {!! Form::open(['route' => ['role.update',$role->id],'method' => 'put','class'=>'form-horizontal form-label-left','data-parsley-validate novalidate']) !!}

                            <div class="form-group">
                                {{ Form::label('name', 'Rol Adı*', ['class' => 'control-label col-md-3 col-sm-3 col-xs-12']) }}
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    {{ Form::text('name',$role->name,['class' => 'form-control col-md-7 col-xs-12','required']) }}
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                   ...
                                   @foreach(config('genel_ayarlar.izinler') as $key=>$value)
                                    ...
                                    <div class="checkbox col-md-4 col-xs-12">
                                        <label>
                                            {{ Form::checkbox('permissions[]',$key,(array_key_exists($key,$role->permissions))?true:false,['class'=>'flat']) }} {{$value}}
                                        </label>
                                    </div>
